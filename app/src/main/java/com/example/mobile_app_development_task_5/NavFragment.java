package com.example.mobile_app_development_task_5;
...
public class NavFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        button.setOnClickListener(v -> NavHostFragment.findNavController(NavFragment.this)
                .navigate(R.id.action_navFragment_to_navFragment1));
        return view;
    }
